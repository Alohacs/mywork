...
public class BiccTest {
     ...
     * @param file  需要识别的文件
     */
    public static Session asrOne(ISessionController controller, String file) {
        ...
        Session.Config config = Session.createConfig(Session.Config.RoleId.CUSTOMER, false);
        ...
        */
        ...
        try {
            ...
            e.printStackTrace();
            System.err.println("meet exception to exit asrOne()");
            System.exit(5);
        }
        return session;
    }

    public static Session asrBoth(final ISessionController controller, final String fileAgent,
                                  final String fileCustomer) {
        return asrBoth(controller, fileAgent, fileCustomer, false);
    }
    ...
    public static Session asrBoth(final ISessionController controller, final String fileAgent,
        ...
        try {
            ...
            e.printStackTrace();
            System.err.println("meet exception to exit asrBoth()");
            System.exit(5);
        }
        return null;
    }
